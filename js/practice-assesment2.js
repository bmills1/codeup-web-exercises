...
//
//1.write a function makeCar
//2. parameter 2 strings
//3.return an object with the properties make and model that correspond to the parameters
...
//1. add methods to salesReport object
//2. getEmployeeCount returns employee sum of employee numbers from salesReport
//3. getTotalNumberOfSales returns sum of salesUnits from salesReport Object
//4.  getAverageSalesPerEmployee() returns average of salesUnit from SalesReport object
...
// salesReport.employeeCount = function getEmployeeCount (){
//     var total = 0;
//     salesReport.employees.forEach(function(){
//       total += salesReport.employees.employeesNumber;
//
//     });console.log(total);
//    return total;
// };
